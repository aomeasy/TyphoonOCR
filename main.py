...
def main():
    ...
    """, unsafe_allow_html=True)
       ...
       # === User Guide (place right after the header, before the sidebar) ===
    with st.expander("📖 คู่มือการใช้งาน Typhoon OCR", expanded=True):
        st.markdown("""
### 🌟 ภาพรวมระบบ
...
- **0.2-0.5 ⚖️ สมดุล**  
  ...
  - เหมาะสำหรับเอกสารที่มีเนื้อหาซับซ้อน / ต้องการการตีความ  
- **0.6-1.0 🌟 สร้างสรรค์**  
  - ผลลัพธ์หลากหลายมาก  
...
**ค่าแนะนำ:**
- **0.1-0.3 📊 เข้มงวด**  
  เลือกเฉพาะคำที่แน่นอนที่สุด — เหมาะกับงานที่ต้องการความแม่นยำสูง  
- **0.6 🎯 ค่าแนะนำ (Default)**  
  สมดุลแม่นยำ/หลากหลาย — เหมาะกับ OCR ทั่วไป  
- **0.8-1.0 🎲 หลากหลาย**  
  เปิดโอกาสคำหลากหลาย — ผลอาจไม่นิ่ง  

**การทำงานร่วมกับ Temperature:**
- Temp ต่ำ + Top P ต่ำ → **แม่นยำมาก**  
- Temp ต่ำ + Top P สูง → **แม่นยำแต่หลากหลาย**  
- Temp สูง + Top P ต่ำ → **สร้างสรรค์แต่คุมได้**  
- Temp สูง + Top P สูง → **สร้างสรรค์มาก**  

#### 📝 Max Tokens (จำนวนคำสูงสุด)
**คืออะไร:** จำนวนข้อความสูงสุดที่ AI สร้างได้  
**ค่าแนะนำ:**
- **1,000–3,000:** เอกสารสั้น (ใบเสร็จ, ฟอร์มสั้น)  
- **4,000–8,000:** เอกสารกลาง (รายงาน 2–3 หน้า)  
- **9,000–16,384:** เอกสารยาว (หนังสือ, รายงานใหญ่)  
> หมายเหตุ: ค่าสูงขึ้น = ใช้เวลา/ทรัพยากรมากขึ้น
...
#### 🎭 ประเภท Prompt
**🔹 Default (เอกสารทั่วไป)** — เหมาะกับ  
- เอกสารข้อความธรรมดา, ไม่มีตารางซับซ้อน, เลย์เอาต์ตรงไปตรงมา  
**ตัวอย่าง:** จดหมาย, ข่าว, บทความธรรมดา, ฟอร์มพื้นฐาน  
**ผลลัพธ์:** Markdown แบบธรรมดา  

**🔸 Structure (เอกสารซับซ้อน)** — เหมาะกับ  
- เอกสารที่มี **ตาราง/รูป/ไดอะแกรม** และเลย์เอาต์หลากหลาย  
**ตัวอย่าง:** รายงานการเงิน, เอกสารวิชาการ, แบบฟอร์มราชการ, เมนูมีรูป, อินโฟกราฟิก  
**ผลลัพธ์:** HTML + Markdown พร้อมแท็ก `<figure>`

#### 📤 รูปแบบผลลัพธ์ (Output Format)
**📝 Markdown**  
- ข้อดี: อ่านง่าย, ใช้ได้หลายแพลตฟอร์ม, แก้ไขง่าย  
- ข้อจำกัด: ตารางซับซ้อนอาจแสดงไม่ครบ  
- เหมาะ: เอกสารทั่วไป, นำไปใช้ต่อ  

**🌐 HTML**  
- ข้อดี: รักษาโครงสร้างตาราง (รวม merged cells) ได้ดี  
- ข้อจำกัด: ซับซ้อนกว่า ต้องเปิดด้วยเบราว์เซอร์  
- เหมาะ: เอกสารตารางซับซ้อน, แสดงผลบนเว็บ  

**📊 JSON**  
- ข้อดี: โครงสร้างข้อมูลชัดเจน, เหมาะประมวลผลต่อ/มี metadata  
- ข้อจำกัด: อ่านยากสำหรับผู้ใช้ทั่วไป  
- เหมาะ: นักพัฒนา, pipeline อัตโนมัติ  
...
**คืออะไร:** ป้องกันคำ/ประโยคซ้ำมากเกินไป  
**ค่าแนะนำ:**
- **1.0:** ปิด (อาจซ้ำ)  
- **1.1–1.2:** ปกติ (แนะนำ)  
- **1.3–1.5:** เข้มงวดปานกลาง  
- **1.6–2.0:** เข้มงวดมาก (*ผลอาจแปลก*)  

**เมื่อไหร่ควรปรับ:**
- เอกสารมีข้อมูลซ้ำๆ → ตั้ง **1.3–1.4**  
- ผลลัพธ์ซ้ำมาก → เพิ่มค่า  
- ผลลัพธ์ดูผิดปกติ → ลดค่า  

#### 🖼️ คุณภาพภาพ (Image Quality)
**🔍 สูง (High - 300 DPI)**  
- ข้อดี: คมชัดสุด อ่านตัวเล็กดี เหมาะเอกสารสำคัญ/ตารางซับซ้อน  
- ข้อจำกัด: ใช้เวลานาน/แบนด์วิธสูง  

**⚖️ กลาง (Medium - 200 DPI)**  
- สมดุลคุณภาพ/ความเร็ว เหมาะใช้งานทั่วไป  

**⚡ ต่ำ (Low - 150 DPI)**  
- เร็วสุด/ประหยัด เหมาะการทดสอบหรือข้อความตัวใหญ่  

---

### 📊 ตัวชี้วัดประสิทธิภาพ

#### ⏱️ เวลาประมวลผล (โดยประมาณ)
- เอกสาร 1 หน้า: **1–3 วินาที**  
- PDF 10 หน้า: **10–30 วินาที**  
- ไฟล์ใหญ่ (>5MB): **30–60 วินาที**  
**ปัจจัย:** ขนาดไฟล์, คุณภาพภาพ, โมเดล, ความซับซ้อนเอกสาร

#### 🎯 ความแม่นยำ (โดยประมาณ)
- ใบเสร็จ/บิล: **95–98%**  
- เอกสารราชการ: **92–96%**  
- หนังสือ/บทความ: **88–94%**  
- เอกสารมีรูปภาพ: **85–92%**  
**ปัจจัย:** Temperature, คุณภาพต้นฉบับ, ประเภทเอกสาร, ภาษา

#### 💰 ต้นทุนการประมวลผล*  
- Typhoon OCR: **฿0.05/หน้า**  
- Qwen2.5: **฿0.08/หน้า**  
- Typhoon2: **฿0.06/หน้า**  
**เคล็ดลับประหยัด:** เลือกคุณภาพภาพให้เหมาะ, ใช้ batch processing, ตั้ง max tokens ให้พอดี  
<sub>*ตัวเลขเป็นตัวอย่างสำหรับอธิบายแนวคิดเท่านั้น</sub>
...
- การทดสอบ: **คุณภาพ Low + Temperature ต่ำ**  
- งานสำคัญ: **คุณภาพ High + Temperature 0.1**  

**🚀 การเพิ่มประสิทธิภาพ**
- ใช้ **Batch Processing** สำหรับหลายไฟล์  
- เลือก **โมเดล** ให้เหมาะชนิดเอกสาร  
- ตั้ง **Max Tokens** ให้พอดี  
- **ทวนผลลัพธ์** ก่อนใช้งานจริง  
...
**🔴 ปัญหาที่พบบ่อย**
- ผลลัพธ์ไม่แม่นยำ → *Temperature สูงเกิน* → ลดเป็น **0.1**  
- อ่านตัวเล็กไม่ได้ → *คุณภาพภาพต่ำ* → ใช้ **High**  
- ตารางเพี้ยน → *ใช้ Default prompt* → เปลี่ยนเป็น **Structure + HTML**  
- ประมวลผลช้า → *ไฟล์ใหญ่/คุณภาพสูง* → ลด DPI หรือแยกไฟล์  
- ข้อความซ้ำ → *Repetition penalty ต่ำ* → เพิ่มเป็น **1.3–1.4**  
